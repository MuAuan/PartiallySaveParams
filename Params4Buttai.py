...
model.load_weights("block_3_1_009", by_name=True)
model.load_weights("block_3_2_009", by_name=True)
model.load_weights("block_3_3_009", by_name=True)
model.load_weights("block_4_1_009", by_name=True)
model.load_weights("block_4_2_009", by_name=True)
model.load_weights("block_4_3_009", by_name=True)
model.load_weights("block_5_1_009", by_name=True)
model.load_weights("block_5_2_009", by_name=True)
model.load_weights("block_5_3_009", by_name=True)
"""
...
if not data_augmentation:
    ...
    for j in range(2):
        ...
        model.save_weights("block_3_1_{0:03d}".format(j))
        model.save_weights("block_3_2_{0:03d}".format(j))
        model.save_weights("block_3_3_{0:03d}".format(j))
        model.save_weights("block_4_1_{0:03d}".format(j))
        model.save_weights("block_4_2_{0:03d}".format(j))
        model.save_weights("block_4_3_{0:03d}".format(j))
        model.save_weights("block_5_1_{0:03d}".format(j))
        model.save_weights("block_5_2_{0:03d}".format(j))
        model.save_weights("block_5_3_{0:03d}".format(j))
        """
        model.save_weights("fc6_{0:03d}".format(j))
        model.save_weights("fc7_{0:03d}".format(j))
        model.save_weights("block_6_1_{0:03d}".format(j))
        model.save_weights("block_6_2_{0:03d}".format(j))
        model.save_weights("block_7_1_{0:03d}".format(j))
        model.save_weights("block_7_2_{0:03d}".format(j))
        model.save_weights("block_8_1_{0:03d}".format(j))
        model.save_weights("block_8_2_{0:03d}".format(j))
